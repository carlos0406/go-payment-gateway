...
func (r *InvoiceRepository) FindByAccountID(accountID string, pagination *domain.Pagination) (*domain.PaginationOutput[domain.Invoice], error) {
	...
	result := &domain.PaginationOutput[domain.Invoice]{
		Total:       count,
